//! Ollama Cloud has no documented conversation/shard field. Strip Codex/Grok only.
...
/// Strip Codex/Grok fields. Do not invent `cached_tokens` or a sticky header.
#[must_use]
