import { startDevice, waitForApproval } from './oauth.js';
let watch;
export function resetLoginWatch() {
    watch = undefined;
}
...
export async function startLogin(origin, persist, signal) {
    ...
    void waitForApproval(origin, started).then(async (approved) => {
